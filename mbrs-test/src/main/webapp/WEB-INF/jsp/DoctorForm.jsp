...
<body>
    ...
    <c:url var="action" value="/doctor" />		
    <div class="container">
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6 border p-4">
                <h5 class="text-center">New Doctor form</h5>
                <form:form class="p-2" action="${action}" method="post" modelAttribute="doctor">
                    ...
                    <div class="form-group">
                        ...
                        <form:select path="surname" cssClass="form-control">
                            <option value="-1">Select a surname</option>
                            <form:options items="${surnames}" itemValue="id"/>
                        </form:select>	
                    </div>
                    <div class="form-group">
                        <form:label path="jmbg">Jmbg</form:label>
                        <form:select path="jmbg" cssClass="form-control">
                            <option value="-1">Select a jmbg</option>
                            <form:options items="${jmbgs}" itemValue="id"/>
                        </form:select>	
                    </div>
                    <div class="form-group">
                        <form:label path="phoneNumber">PhoneNumber</form:label>
                        <form:select path="phoneNumber" cssClass="form-control">
                            <option value="-1">Select a phoneNumber</option>
                            <form:options items="${phoneNumbers}" itemValue="id"/>
                        </form:select>	
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <form:select path="specialty" cssClass="form-control">
                            <option value="-1">Select a specialty</option>
                            <form:options items="${specialtys}" itemValue="id"/>
                        </form:select>	
                    </div>
                    <div>
